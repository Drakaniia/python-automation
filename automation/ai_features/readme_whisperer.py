...
AI-powered changelog generator and commit message creator from git commits
Transforms commit diffs into elegant, human-readable changelog entries and commit messages
"""
import subprocess
...
class CommitSummarizer:
    """Generates changelog entries and commit messages from git history"""
    ...
    # ===== CHANGELOG GENERATION (Original functionality) =====
